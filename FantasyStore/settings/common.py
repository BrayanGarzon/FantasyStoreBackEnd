...
ROOT_URLCONF = 'FantasyStore.urls'
...
ASGI_APPLICATION = "FantasyStore.asgi.application"
...
DEFAULT_FROM_EMAIL = 'No Reply <FantasyStore@gmail.co>'
SERVER_EMAIL = 'Server <FantasyStore@gmail.co>'
